...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2015 a las 23:34:46
...
INSERT INTO `areas` (`id`, `name`, `telf`, `created_at`, `update_at`, `user_id`) VALUES
(1, 'Santa Rosa', '124', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(2, 'Loma Linda', '154', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1);
...
(1, 'ADMINISTRADOR'),
(2, 'ANALISTA DE CONTROL Y TRAZABILIDAD'),
(3, 'ANALISTA DE LABORATORIO'),
(4, 'APRENDIZ INCE'),
(5, 'ASESOR DE SERVICIOS AL CLIENTE'),
(6, 'ASESOR LEGAL'),
(7, 'ASISTENTE'),
(8, 'ASISTENTE DE ADMINISTRACION'),
(9, 'ASISTENTE DE ALMACEN'),
(10, 'ASISTENTE DE COMPRAS'),
(11, 'ASISTENTE DE CONTABILIDAD'),
(12, 'ASISTENTE DE FACTURACION'),
(13, 'ASISTENTE DE LOGISTICA OPERACIONAL'),
(14, 'ASISTENTE DE PLANIFICACION'),
(15, 'ASISTENTE DE RECURSOS HUMANOS'),
(16, 'ASISTENTE DE TRAZABILIDAD'),
(17, 'AYUDANTE DE CHOFER'),
(18, 'CHOFER'),
(19, 'CONTADOR'),
(20, 'COORDINADOR AMBIENTAL'),
(21, 'COORDINADOR DE CALIDAD'),
(22, 'COORDINADOR DE TALADROS'),
(23, 'CUSTODIO DEL DESECHO'),
(24, 'ELECTRICISTA'),
(25, 'GERENTE DE CASSO'),
(26, 'GERENTE DE IT'),
(27, 'GERENTE DE OPERACIONES Y COMERCIALIZACION'),
(28, 'GERENTE DE PLANTA '),
(29, 'INSPECTOR CASSO'),
(30, 'LOGISTICA OPERACIONAL'),
(31, 'MANTENIMIENTO OFICINA'),
(32, 'OBRERO'),
(33, 'OPERADOR DE INCINERACION'),
(34, 'OPERADOR DE MANTENIMIENTO'),
(35, 'OPERADOR DE TRAT. DE EFLUENTES'),
(36, 'PARAMEDICO'),
(37, 'PLANIFICADOR'),
(38, 'RECEPCIONISTA'),
(39, 'RECEPTOR DE DESECHOS'),
(40, 'SOLDADOR'),
(41, 'SUPERV. DE AREA DE BIORREMEDIACION'),
(42, 'SUPERVISOR'),
(43, 'SUPERVISOR AMBIENTAL'),
(44, 'SUPERVISOR CASSO'),
(45, 'SUPERVISOR DE  RR HH Y NOMINA'),
(46, 'SUPERVISOR DE COMPRAS'),
(47, 'SUPERVISOR DE FINANZAS'),
(48, 'SUPERVISOR DE LOGISTICA OPERACIONAL'),
(49, 'SUPERVISOR DE OPERACIONES'),
(50, 'SUPERVISOR DE SERVICIOS AL CLIENTE'),
(51, 'SUPERVISOR SIHO'),
(52, 'TRABAJADOR NIVEL 2'),
(53, 'VIGILANTE DE 1ERA.');
...
CREATE TABLE IF NOT EXISTS `centros` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nombre_UNIQUE` (`nombre`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='centros integrales de manejo de desechos' AUTO_INCREMENT=4 ;
...
--
-- Estructura de tabla para la tabla `educationlevels`
--
...
--
-- Volcado de datos para la tabla `educationlevels`
--

INSERT INTO `educationlevels` (`id`, `nombre`) VALUES
(1, 'Educación Inicial '),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Registros de empleados' AUTO_INCREMENT=116 ;

--
-- Volcado de datos para la tabla `empleados`
--

INSERT INTO `empleados` (`id`, `centro_id`, `nombre`, `segundo_nombre`, `apellido`, `segundo_apellido`, `ci`, `rif`, `maritalstatus_id`, `fecha_nacimiento`, `sexo_id`, `sangre_tipo`, `lateralidad`, `telf_fijo`, `telf`, `educationlevel_id`, `cargo_id`, `estado_id`, `municipio_id`, `parroquia_id`, `direccion`, `discapacidad`, `nombre_contacto`, `telf_contacto`, `created_at`, `updated_at`) VALUES
(13, 1, 'Elvis', 'José', 'Reyes', 'Centeno', '18205603', '18205603-7', 2, '0000-00-00', 1, 'a+', 'siniestro', 'N/A', '04164938565', 1, 2, 2, 8, 27, '#2 Las vegas Edo Anzoátegui', 'N/a', NULL, NULL, '2015-08-04 19:22:54', '2015-08-03 17:37:21'),
(93, 2, 'Manuel', 'Ramon', 'Martinez', 'Nomo', '182056045', '18205603-6', 5, '2015-08-06', 2, 'b-', 'diestro', '', '04164938565', 4, 5, 6, 68, 226, '#2 Las vegas Edo Anzoátegui', '', 'AMELIA', '977', '2015-08-04 21:08:32', '2015-08-04 21:08:32'),
(94, 1, 'Ramon', 'Alvarado', 'Martinez', 'Capielo', '18205605', '18205603-5', 5, '2015-04-08', 2, 'a+', 'diestro', '', '3465', 1, 1, 2, 9, 29, 'kjhkjh', '', 'kjhkj', 'kjhk', '2015-08-05 12:38:23', '2015-08-05 12:38:23'),
(95, 1, 'Julio', 'Manuel', 'Sinfontes', 'Martinez', '18205604', '12', 3, '2015-27-07', 2, 'b-', 'siniestro', '12', '12', 4, 15, 14, 232, 626, '12', '', '1212', '1212', '2015-08-05 13:05:59', '2015-08-05 13:05:59'),
(97, 1, 'Ramon', 'Alvarado', 'Martinez', 'Capielo', '18205602', '18205603-2', 5, '2015-04-08', 2, 'a+', 'diestro', '', '3465', 1, 1, 4, 39, 120, 'trujillo', '', 'kjhkj', 'kjhk', '2015-08-05 13:15:03', '2015-08-05 13:15:03'),
(98, 1, 'Ramon', 'Alvarado', 'Martinez', 'Capielo', '18205601', '18205603-1', 5, '2015-04-08', 2, 'a+', 'diestro', '', '3465', 1, 1, 6, 69, 228, 'trujillo 3', '', 'kjhkj', 'kjhk', '2015-08-05 13:16:19', '2015-08-05 13:16:19'),
(100, 1, 'Ramon', 'marta', 'Martinez', 'Nomo', '182056025', 'jh', 2, '2015-04-08', 2, 'a+', 'siniestro', 'N/A', '04164938565', 2, 1, 3, 29, 83, 'sqs', '', 'kjhkj', '977', '2015-08-05 14:31:22', '2015-08-05 14:31:22'),
(101, 1, 'Ramon3', 'Ramon3', 'perez3', 'Nomo', '182056041', '3456', 2, '2015-21-07', 2, 'b+', 'ambidiestro', 'N/A', '04164938565', 2, 8, 16, 274, 704, 'sqs', '', 'kjhkj', '977', '2015-08-05 14:39:04', '2015-08-05 14:39:04'),
(102, 1, 'Manuel', 'marta', 'Martinez', 'cedeño', '18205600', '34556', 5, '2015-28-07', 1, 'a-', 'ambidiestro', 'sdf', '3465', 3, 5, 3, 32, 95, '#2 Las vegas Edo Anzoátegui', '', 'AMELIA', 'pdf', '2015-08-05 15:23:34', '2015-08-05 15:23:34'),
(103, 2, 'Louis', 'Marqui', 'Lopez', 'Guido', '0017396', 'd0017396', 2, '2015-26-07', 2, 'o+', 'diestro', '001122455', '01215488', 5, 16, 14, 236, 636, 'calle la paz', 'nanguna', 'julio prez', '012124547', '2015-08-05 15:50:35', '2015-08-05 15:50:35');
...
INSERT INTO `estados` (`id`, `nombre`, `iso_3166-2`) VALUES
(1, 'Amazonas', 'VE-X'),
(2, 'Anzoátegui', 'VE-B'),
(3, 'Apure', 'VE-C'),
(4, 'Aragua', 'VE-D'),
...
INSERT INTO `familiars` (`id`, `nombre`, `parentesco`, `nacimiento`, `sexo_id`, `empleado_id`, `created_at`, `updated_at`) VALUES
(3, 'Alcira Genoveba', 'sed', '2015-07-07', 1, 101, '2015-08-05 14:39:04', '2015-08-05 14:39:04'),
(4, 'Alcira Genovebapdf', 'Madrepdf', '2015-03-08', 1, 102, '2015-08-05 15:23:34', '2015-08-05 15:23:34'),
(5, 'jorgepdf', 'espdf', '2015-15-07', 2, 102, '2015-08-05 15:23:34', '2015-08-05 15:23:34'),
(6, 'julio perez', 'tio', '2015-26-07', 2, 103, '2015-08-05 15:50:35', '2015-08-05 15:50:35'),
(7, 'julia perez', 'tia', '2015-26-07', 1, 103, '2015-08-05 15:50:35', '2015-08-05 15:50:35');
...
INSERT INTO `groups` (`id`, `name`, `created_at`, `updated_at`, `zone_id`, `schedule_id`) VALUES
(2, 'cazador', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 2, NULL),
(3, 'Antorcha', '2015-07-27 15:10:30', '2015-07-27 15:10:30', 2, NULL),
(4, 'Vengala', '2015-07-27 15:10:51', '2015-07-27 15:10:51', 3, NULL);
...
INSERT INTO `maritalstatus` (`id`, `nombre`) VALUES
(1, 'Soltero/a'),
(2, 'Casado/a'),
(3, 'Divorciado/a'),
(4, 'Viudo/a'),
...
('2015_07_13_185459_create_users_table', 1),
('2015_07_16_130539_create_password_reminders_table', 1),
('2015_07_20_162151_create_areas_table', 1),
('2015_07_20_163918_create_zonas_table', 1),
('2015_07_21_082605_create_person_table', 1),
('2015_07_21_083711_creaate_schedule_table', 1),
('2015_07_21_084211_creaate_group_table', 1),
('2015_07_21_084941_creaate_send_table', 1),
('2015_07_21_093148_creaate_stacion_table', 1),
('2015_07_21_094559_creaate_type-alert_table', 1),
('2015_07_21_100555_creaate_alert_table', 1),
('2015_07_21_141125_create_message_table', 1),
('2015_07_21_144011_create_relaciontableUseryMessages', 2),
('2015_07_21_145127_create_relaciontableAlertMessages', 3),
('2015_07_21_145741_typeUser', 4),
('2015_07_21_150412_create_code_table', 5),
('2015_07_22_141856_create_relacionZoneArea_table', 6),
('2015_07_22_143208_create_relacionUserArea_table', 7),
('2015_07_22_153433_create_centinela_table', 7),
('2015_07_27_094404_create_relacionGrupoZona_table', 8),
('2015_07_27_095026_create_relacionGroupsSchedule_table', 9),
('2015_07_27_133930_create_seoZona_table', 10),
('2015_07_28_080729_create_session_table', 11);
...
--
-- Estructura de tabla para la tabla `sentinels`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tabla para identificar el género' AUTO_INCREMENT=3 ;
...
--
-- Estructura de tabla para la tabla `types_alerts`
--
...
INSERT INTO `types_users` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'admin', '2015-07-21 04:30:00', '2015-07-21 04:30:00'),
(2, 'superadmin', '2015-07-21 04:30:00', '2015-07-21 04:30:00'),
(3, 'supervisor', '2015-07-21 04:30:00', '2015-07-21 04:30:00'),
(4, 'area_manager', '2015-07-21 04:30:00', '2015-07-21 04:30:00'),
(5, 'guard', '2015-07-21 04:30:00', '2015-07-21 04:30:00');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Usuarios del sistema' AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `users`
--

INSERT INTO `users` (`id`, `id_person`, `typeuser_id`, `group_id`, `id_creator`, `name`, `identify_card`, `telf`, `ext`, `address`, `nickname`, `email`, `password`, `remember_token`, `activo`, `created_at`, `updated_at`) VALUES
(1, NULL, 1, NULL, NULL, 'Elvis Reyes', '18205603', '555555', '211', NULL, 'Admin', 'teclaelvis01@gmail.com', '$2y$10$PZli6jcRyx76wagHJKrR7OcN3.h83vf9McUSkA2k1xdFM4KD7tBCq', '2O8pUWfrSu1hGtfry73nJInxxkyIPGsiOEgi256xNtZQyBCsab57wFKIRdVL', 0, '2015-07-13 19:17:26', '2015-08-05 16:41:14'),
(2, NULL, 2, 2, NULL, 'John Maxwell', NULL, NULL, NULL, NULL, 'John', 'teclaelvis01@hotmail.com', '$2y$10$MGl/G2NWW4s7MCkOcoC5Eebo9xpAzqukJsd0.4A7Fp3ZGcLmjKT6y', 'LR4Vvdc7v3AUlpVtDvYouUcjMOmQ9Gv5Jqyq6O6YxQs4JYg6PyHLtbOdagTF', 0, '2015-07-20 14:36:52', '2015-07-27 09:13:49'),
(3, NULL, 4, NULL, NULL, 'Tirso', '123123123', NULL, NULL, NULL, 'tirzo.ruiz', 'tirzo.ruiz@evergreenservice.net', '$2y$10$PZli6jcRyx76wagHJKrR7OcN3.h83vf9McUSkA2k1xdFM4KD7tBCq', NULL, 1, '2015-08-05 00:00:00', '2015-08-05 16:41:27');
...
INSERT INTO `zones` (`id`, `name`, `uri`, `created_at`, `updated_at`, `area_id`) VALUES
(2, 'Clave 01-A', 'clave-01-a', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(3, 'Clave 02-A', 'clave-02-a', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(4, 'Clave 03-A', 'clave-03-a', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(5, 'Clave 04-A', 'clave-04-a', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(6, 'Clave 05-A', 'clave-05-a', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1);
...
--
ALTER TABLE `alerts`
  ADD CONSTRAINT `alerts_message_id_foreign` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`),
  ADD CONSTRAINT `alerts_station_id_foreign` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`),
  ADD CONSTRAINT `alerts_typealert_id_foreign` FOREIGN KEY (`typealert_id`) REFERENCES `types_alerts` (`id`);
...
--
ALTER TABLE `codes`
  ADD CONSTRAINT `codes_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  ADD CONSTRAINT `codes_station_id_foreign` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`);
...
ALTER TABLE `empleados`
  ...
  ADD CONSTRAINT `empleados_ibfk_2` FOREIGN KEY (`maritalstatus_id`) REFERENCES `maritalstatus` (`id`),
  ADD CONSTRAINT `empleados_ibfk_3` FOREIGN KEY (`cargo_id`) REFERENCES `cargos` (`id`),
  ADD CONSTRAINT `empleados_ibfk_4` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`),
  ADD CONSTRAINT `empleados_ibfk_5` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`),
  ADD CONSTRAINT `empleados_ibfk_6` FOREIGN KEY (`parroquia_id`) REFERENCES `parroquias` (`id`),
  ADD CONSTRAINT `empleados_ibfk_7` FOREIGN KEY (`sexo_id`) REFERENCES `sexos` (`id`),
  ADD CONSTRAINT `empleados_ibfk_8` FOREIGN KEY (`educationlevel_id`) REFERENCES `educationlevels` (`id`);

--
-- Filtros para la tabla `familiars`
--
ALTER TABLE `familiars`
  ADD CONSTRAINT `familiars_ibfk_2` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`id`),
  ADD CONSTRAINT `familiars_ibfk_3` FOREIGN KEY (`sexo_id`) REFERENCES `sexos` (`id`);

--
-- Filtros para la tabla `groups`
--
ALTER TABLE `groups`
  ADD CONSTRAINT `groups_schedule_id_foreign` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`),
  ADD CONSTRAINT `groups_zone_id_foreign` FOREIGN KEY (`zone_id`) REFERENCES `zones` (`id`);

--
-- Filtros para la tabla `messages`
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_alert_id_foreign` FOREIGN KEY (`alert_id`) REFERENCES `alerts` (`id`),
...
--
-- Filtros para la tabla `sends`
--
ALTER TABLE `sends`
  ADD CONSTRAINT `sends_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`);

--
-- Filtros para la tabla `sentinels`
--
ALTER TABLE `sentinels`
  ADD CONSTRAINT `sentinels_area_id_foreign` FOREIGN KEY (`area_id`) REFERENCES `areas` (`id`),
  ADD CONSTRAINT `sentinels_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Filtros para la tabla `stations`
--
ALTER TABLE `stations`
  ADD CONSTRAINT `stations_zone_id_foreign` FOREIGN KEY (`zone_id`) REFERENCES `zones` (`id`);

--
-- Filtros para la tabla `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`typeuser_id`) REFERENCES `types_users` (`id`),
...
--
ALTER TABLE `zones`
  ADD CONSTRAINT `zones_area_id_foreign` FOREIGN KEY (`area_id`) REFERENCES `areas` (`id`);
