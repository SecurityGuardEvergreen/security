...
CREATE TABLE `empleados` (
  ...
  KEY `sexo_id` (`sexo_id`),
  CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`centro_id`) REFERENCES `centros` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='Registros de empleados';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empleados` VALUES (13,1,'Elvis','José','Reyes','Centeno','18205603','18205603-7',2,'0000-00-00 00:00:00',1,'a+','siniestro','N/A','04164938565',2,2,8,27,'#2 Las vegas Edo Anzoátegui','N/a','2015-08-03 17:37:21','2015-08-03 17:37:21'),(46,1,'Manuel','Jose','Ferna','Patillo','323','2323',5,'2015-06-08 00:00:00',1,'a-','diestro','','2323',8,6,70,237,'','','2015-08-04 06:29:45','2015-08-04 06:29:45');
...
CREATE TABLE `familiars` (
  ...
  CONSTRAINT `familiars_ibfk_1` FOREIGN KEY (`sexo_id`) REFERENCES `sexos` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Usuarios del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,NULL,1,NULL,NULL,'Elvis Reyes','18205603','555555','211',NULL,'Admin','teclaelvis01@gmail.com','$2y$10$PZli6jcRyx76wagHJKrR7OcN3.h83vf9McUSkA2k1xdFM4KD7tBCq','OQg6tIjbV11fX1XBLkuIlbXFs7GPSCFkZ0uKDuxMlbnPkKC8OPjxi1PpsgNI',0,'2015-07-13 19:17:26','2015-07-30 18:20:22'),(2,NULL,2,2,NULL,'John Maxwell',NULL,NULL,NULL,NULL,'John','teclaelvis01@hotmail.com','$2y$10$MGl/G2NWW4s7MCkOcoC5Eebo9xpAzqukJsd0.4A7Fp3ZGcLmjKT6y','LR4Vvdc7v3AUlpVtDvYouUcjMOmQ9Gv5Jqyq6O6YxQs4JYg6PyHLtbOdagTF',0,'2015-07-20 14:36:52','2015-07-27 09:13:49');
...
-- Dump completed on 2015-08-04  2:02:18
