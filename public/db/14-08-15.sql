...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `empleados_ibfk_11` FOREIGN KEY (`prefirif_id`) REFERENCES `rifs` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 COMMENT='Registros de empleados';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empleados` VALUES (13,'lkj','Elvis','José','Reyes','Centeno',1,'18205603',1,'182056037',2,'0000-00-00',1,'a+','siniestro','N/A','04164938565',1,2,2,8,27,'#2 Las vegas Edo Anzoátegui','N/a',NULL,NULL,NULL,'2015-08-10 19:23:11','2015-08-03 17:37:21',3),(114,'OFICINA ANACO','Reyes','Elvis','Reyes','',1,'20986573',2,'098761231',5,'05-06-1991',1,'b+','diestro','+584164938565','+584164938565',2,5,2,13,36,'C/ San Antonio Las vegas #2','','Elvis Reyes','Vecino','+584164938565','2015-08-14 05:40:21','2015-08-14 05:40:21',NULL);
...
INSERT INTO `familiars` VALUES (8,'Hexelys','Varela','190293713','Sobrino','04-06-2014',1,114,'2015-08-14 05:40:21','2015-08-14 05:40:21'),(9,'Martin','Carvalas','90121872','Primo','28-07-2015',2,114,'2015-08-14 05:40:21','2015-08-14 05:40:21');
...
INSERT INTO `rifs` VALUES (1,'Venezolano','v'),(2,'Jurídico','j'),(3,'Gubernamental','g'),(4,'Extranjero','e');
...
INSERT INTO `users` VALUES (1,NULL,1,NULL,NULL,'Elvis Reyes',1,'18205603','555555','211',NULL,'Admin','teclaelvis01@gmail.com','$2y$10$PZli6jcRyx76wagHJKrR7OcN3.h83vf9McUSkA2k1xdFM4KD7tBCq','eEdpsIbhXC2PFnhVXtSC6jBvjYC9chyNDxHeloj70Umh581HIhvUM0RmTD5u',1,'2015-07-13 19:17:26','2015-08-14 00:17:57'),(2,NULL,2,2,NULL,'John Maxwell',1,NULL,NULL,NULL,NULL,'John','teclaelvis01@hotmail.com','$2y$10$MGl/G2NWW4s7MCkOcoC5Eebo9xpAzqukJsd0.4A7Fp3ZGcLmjKT6y','LR4Vvdc7v3AUlpVtDvYouUcjMOmQ9Gv5Jqyq6O6YxQs4JYg6PyHLtbOdagTF',0,'2015-07-20 14:36:52','2015-07-27 09:13:49'),(3,NULL,4,NULL,NULL,'Tirso',1,'123123123',NULL,NULL,NULL,'tirzo.ruiz','tirzo.ruiz@evergreenservice.net','$2y$10$PZli6jcRyx76wagHJKrR7OcN3.h83vf9McUSkA2k1xdFM4KD7tBCq','uHJ00UzWnKeh1tJqjulN3AuvKp1PqdqijQcHuPvFqkkbDCSJghw9Tvpn1zgm',1,'2015-08-05 00:00:00','2015-08-13 23:50:53');
...
-- Dump completed on 2015-08-14  1:13:21
