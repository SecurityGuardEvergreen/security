...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-08-2015 a las 23:30:50
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  KEY `sexo_id` (`sexo_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Registros de empleados' AUTO_INCREMENT=23 ;

--
-- Volcado de datos para la tabla `empleados`
--

INSERT INTO `empleados` (`id`, `centro_id`, `nombre`, `segundo_nombre`, `apellido`, `segundo_apellido`, `ci`, `rif`, `maritalstatus_id`, `fecha_nacimiento`, `sexo_id`, `sangre_tipo`, `lateralidad`, `telf_fijo`, `telf`, `cargo_id`, `estado_id`, `municipio_id`, `parroquia_id`, `direccion`, `discapacidad`, `created_at`, `updated_at`) VALUES
(13, 1, 'Elvis', 'José', 'Reyes', 'Centeno', '18205603', '18205603-7', 2, '0000-00-00 00:00:00', 1, 'a+', 'siniestro', 'N/A', '04164938565', 2, 2, 8, 27, '#2 Las vegas Edo Anzoátegui', 'N/a', '2015-08-03 17:37:21', '2015-08-03 17:37:21');
...
INSERT INTO `familiars` (`id`, `nombre`, `parentesco`, `edad`, `sexo_id`, `empleado_id`, `created_at`, `updated_at`) VALUES
(20, 'Alcira Genoveba', 'Madre', '46', 2, 13, '2015-08-03 17:37:21', '2015-08-03 17:37:21'),
(21, 'Neila Vallenilla', 'Prometida', '24', 1, 13, '2015-08-03 17:37:21', '2015-08-03 17:37:21');
...
ALTER TABLE `familiars`
  ...
  ADD CONSTRAINT `familiars_ibfk_1` FOREIGN KEY (`sexo_id`) REFERENCES `sexos` (`id`);
